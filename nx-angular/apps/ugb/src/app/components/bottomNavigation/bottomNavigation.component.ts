...
@Component({
    ...
    template: `
      <nav class="md:hidden fixed bottom-0 left-0 w-full py-3 px-6 bg-secondary text-tertiary shadow-lg flex justify-around overflow-x-auto whitespace-nowrap gap-6">
